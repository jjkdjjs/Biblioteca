                        ...
                        {livrosFiltrados.map(livro => (
                            <article key={livro.id} className="livro-card">
                                <div className="capa-container">
                                    ...
                                    <button
                                        className="favorito-btn-overlay"
                                        onClick={() => isFavorito(livro.id) ? removerFavorito(livro.id) : adicionarFavorito(livro)}
                                        style={{
